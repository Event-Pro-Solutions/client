        ...
        <div className="mx-auto max-w-7xl px-2 md:px-6 lg:px-8">
          <div className="relative flex h-16 items-center justify-between">
            <div className="absolute inset-y-0 left-0 flex items-center md:hidden">
              ...
              <button
                ...
                className={
                  mobileMenu
                    ? "inline-flex items-center justify-center rounded-md p-2 text-primary hover:bg-dark hover:text-secondary focus:outline-none focus:ring-2 focus:ring-inset focus:ring-secondary focus:text-secondary"
                    : "inline-flex items-center justify-center rounded-md p-2 text-primary hover:bg-dark hover:text-secondary focus:outline-none   "
                }
                ...
                {user._id.length > 0 ? (
                  <div>
                    <button
                      ...
                      className={
                        profileMenu
                          ? "flex rounded-full bg-secondary text-sm focus:outline-none focus:ring-2 focus:ring-secondary focus:ring-offset-2 focus:ring-offset-secondary"
                          : "flex rounded-full bg-secondary text-sm focus:outline-none "
                      }
                      id="user-menu-button"
                      aria-expanded="false"
                      aria-haspopup="true"
          ...
          --> */}
                ...
                <div
                  ...
                  className={
                    profileMenu
                      ? "absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-primary py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none "
                      : "absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-primary py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hidden"
                  }
                  role="menu"
          ...
          {user._id.length > 0 ? (
            <div
              ...
              className={
                mobileMenu
                  ...
                  : "space-y-1 px-2 pb-3 pt-2 hidden"
              }
            >
              <a
                href="#"
            ...
            >
              ...
              >
                ...
                {eventMenu ? (
                  <svg
                    className="h-6 w-6 text-secondary inline-block"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                    strokeWidth="2"
